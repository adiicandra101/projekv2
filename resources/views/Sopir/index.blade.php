...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Sopir</h1>
                </div>
                <!-- /.col-lg-12 -->
                {{-- TABLE --}}
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Data Merek
                            <a href="{{ route('sopir.create') }}" class="btn btn-primary float-right">Tambah</a>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sopir as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->status_sopir }}</td>
                                                <td>
                                                    <form action="{{ route('sopir.destroy', $data->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf
                                                        ...
                                                        <a href="{{ route('sopir.show', $data->id) }}"
