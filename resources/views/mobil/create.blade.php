                    ...
                    <div class="panel panel-default">
                        ...
                        <form Action="{{ route('mobil.store') }}" method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="text" class="form-control" name="status mobil">
                                <label>tarif mobil</label>
                                <input type="text" class="form-control" name="tarif mobil">
                                <label>tarif sopir</label>
                                <input type="text" class="form-control" name="tarif sopir">
                            </div>
                            <div class="panel-body">
